...
export function loadSettingsFromStorage(): Settings {
  ...
  try {
    ...
    return {
      ...
      features: {
        focusTimer: obj.features?.focusTimer ?? true,
        quickNotes: obj.features?.quickNotes ?? true,
        dailyInspiration: obj.features?.dailyInspiration ?? true,
        waterTracker: obj.features?.waterTracker ?? true,
        priorityMatrix: obj.features?.priorityMatrix ?? true,
        quickActions: obj.features?.quickActions ?? true,
      },
